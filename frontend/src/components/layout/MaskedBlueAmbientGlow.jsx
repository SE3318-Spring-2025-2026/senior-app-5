/**
 * Masked blue ambient layer — Coordinator layout (see Layout).
 */
export function MaskedBlueAmbientGlow() {
  const maskStyle = {
    WebkitMaskImage:
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: `
                  radial-gradient(ellipse 85% 75% at 50% 18%, rgba(59, 130, 246, 0.42), transparent 58%),
                  radial-gradient(ellipse 70% 60% at 72% 45%, rgba(37, 99, 235, 0.28), transparent 52%),
                  radial-gradient(ellipse 90% 85% at 18% 62%, rgba(96, 165, 250, 0.22), transparent 55%)
                `,
          }}
        />
      </div>
