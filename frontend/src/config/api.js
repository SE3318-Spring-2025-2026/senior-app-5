...
export const apiConfig = {
  ...
  endpoints: {
    ...
    submissionContent: (submissionId) => `/submissions/${submissionId}/content`,
    submissionImages: (submissionId) => `/submissions/${submissionId}/images`,
    submissionImageById: (submissionId, imageId) => `/submissions/${submissionId}/images/${imageId}`,
