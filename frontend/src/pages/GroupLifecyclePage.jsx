  ...
  return (
    <div className={styles.pageContainer}>
      <header className={styles.hero}>
        <p className={styles.badge}>Issue FE-02</p>
        <h1>Team Leader & Student Advisor Flows</h1>
        <p className={styles.lead}>
          Browse advisors, submit or withdraw advisor requests, and inspect group committee and assignment status context.
        </p>
      </header>
