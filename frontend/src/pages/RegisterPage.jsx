          ...
          {done ? (
            <div className="flex flex-col items-center gap-5 text-center py-8">
              ...
              <button
                ...
                className="mt-2 w-full rounded-xl bg-blue-600 py-3 text-sm font-bold text-white
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  {pwd.length > 0 && (
                    <ul className="mt-2 space-y-1 rounded-lg border border-[#1e293b] bg-[#111827] px-4 py-3">
              ...
              <footer className="mt-8 text-center">
                <p className="text-[13px] text-slate-600">
                  Trouble registering?{' '}
                  <a href="#" className="font-semibold text-slate-300 hover:text-blue-400 transition-colors">
